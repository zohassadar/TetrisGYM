...
SUPPORTS_SCROLLTRIS = INES_MAPPER = 1 || INES_MAPPER = 5
...
MENU_HIGHLIGHT_COLOR := $2C ; $12 in gym, $16 in original
BLOCK_TILES := $7B
EMPTY_TILE := $EF
TETRIMINO_X_HIDE := $EF
...
MODE_GAME_QUANTITY = MODE_INVISIBLE + 1
